package com.neodio.httpstatuscode.policy;
...
public enum HttpStatusPolicy {
	...
	public static HttpStatusPolicy findByCode(final String code) {
		return Arrays.stream(HttpStatusPolicy.values())
				.filter(v -> v.getCode().equals(code))
				.findFirst()
				.orElse(HttpStatusPolicy.EMPTY);
	}
}
